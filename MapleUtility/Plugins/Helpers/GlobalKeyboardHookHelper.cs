...
{
    public class GlobalKeyboardHookHelperEventArgs : HandledEventArgs
    {
        public GlobalKeyboardHookHelper.KeyboardState KeyboardState { get; private set; }
        public GlobalKeyboardHookHelper.LowLevelKeyboardInputEvent KeyboardData { get; private set; }

        public GlobalKeyboardHookHelperEventArgs(
            GlobalKeyboardHookHelper.LowLevelKeyboardInputEvent keyboardData,
            GlobalKeyboardHookHelper.KeyboardState keyboardState)
        {
    ...
    {
        public event EventHandler<GlobalKeyboardHookHelperEventArgs> KeyboardPressed;
        ...
        public GlobalKeyboardHookHelper(Key[] registeredKeys = null)
        {
        ...
        public IntPtr LowLevelKeyboardProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (Enum.IsDefined(typeof(KeyboardState), wparamTyped))
            {
                ...
                var eventArguments = new GlobalKeyboardHookHelperEventArgs(p, (KeyboardState)wparamTyped);
                ...
                {
                    EventHandler<GlobalKeyboardHookHelperEventArgs> handler = KeyboardPressed;
