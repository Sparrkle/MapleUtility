...
namespace MapleUtility.Plugins.UserControls
{
    ...
    public class UCOutlineTextBlock : FrameworkElement
    {
        ...
        {
            var UCOutlineTextBlock = (UCOutlineTextBlock)dependencyObject;
            UCOutlineTextBlock._FormattedText = null;
            UCOutlineTextBlock._TextGeometry = null;

            UCOutlineTextBlock.InvalidateMeasure();
            UCOutlineTextBlock.InvalidateVisual();
        }

        private static void OnFormattedTextUpdated(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            var UCOutlineTextBlock = (UCOutlineTextBlock)dependencyObject;
            UCOutlineTextBlock.UpdateFormattedText();
            UCOutlineTextBlock._TextGeometry = null;
